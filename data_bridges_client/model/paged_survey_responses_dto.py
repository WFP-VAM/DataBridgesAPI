...
class PagedSurveyResponsesDTO(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PagedSurveyResponsesDTO - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            total_items (int): The total number of responses. [optional]  # noqa: E501
            page (int): The current page. [optional]  # noqa: E501
            items ([bool, date, datetime, dict, float, int, list, str, none_type], none_type): The list of survey responses. [optional]  # noqa: E501
        """
